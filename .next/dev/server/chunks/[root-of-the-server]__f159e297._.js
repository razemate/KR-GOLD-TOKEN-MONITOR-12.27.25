...
"[project]/Downloads/APPS - PROTOTYPING/Gold Token Monitor - Lovable/src/app/api/gold-intel/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function callOpenRouter(token, apiKey, model) {
    const prompt = `Analyze the tokenized gold token ${token.name} (${token.symbol.toUpperCase()}) with the following data:
- Current price: $${token.current_price?.toLocaleString('en-US', {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f159e297._.js.map